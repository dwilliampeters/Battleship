...
THREE.Car = function () {
	...
	this.MAX_SPEED = 800;
	this.MAX_REVERSE_SPEED = -600;

	this.MAX_WHEEL_ROTATION = 0.6;

	this.FRONT_ACCELERATION = 200;
	this.BACK_ACCELERATION = 100;

	this.WHEEL_ANGULAR_ACCELERATION = 1.000;

	this.FRONT_DECCELERATION = 750;
	this.WHEEL_ANGULAR_DECCELERATION = 1.0;

	this.STEERING_RADIUS_RATIO = 0.00050;

	this.MAX_TILT_SIDES = -0.45;
	this.MAX_TILT_FRONTBACK = -0.1000;
	...
	//back steering
	/*this.backLeftWheelRoot = new THREE.Object3D();
	this.backRightWheelRoot = new THREE.Object3D();*/
	...
	this.updateCarModel = function ( delta, controls ) {
		...
		// back wheels steering

		/*this.backLeftWheelRoot.rotation.y = this.wheelOrientation;
		this.backRightWheelRoot.rotation.y = this.wheelOrientation;*/
