...
THREE.Car = function () {
	...
	this.MAX_SPEED = 1500;
	this.MAX_REVERSE_SPEED = -1200;

	this.MAX_WHEEL_ROTATION = 0.6;

	this.FRONT_ACCELERATION = 300;
	this.BACK_ACCELERATION = 300;

	this.WHEEL_ANGULAR_ACCELERATION = 0.090;

	this.FRONT_DECCELERATION = 750;
	this.WHEEL_ANGULAR_DECCELERATION = 1.0;

	this.STEERING_RADIUS_RATIO = 0.0090;

	this.MAX_TILT_SIDES = 1.05;
	this.MAX_TILT_FRONTBACK = 0.215;
